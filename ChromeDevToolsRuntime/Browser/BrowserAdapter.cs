namespace BaristaLabs.ChromeDevTools.Runtime.Browser
{
    ...
    public class BrowserAdapter
    {
        ...
        /// </summary>
        public async Task<AddPrivacySandboxEnrollmentOverrideCommandResponse> AddPrivacySandboxEnrollmentOverride(AddPrivacySandboxEnrollmentOverrideCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<AddPrivacySandboxCoordinatorKeyConfigCommandResponse> AddPrivacySandboxCoordinatorKeyConfig(AddPrivacySandboxCoordinatorKeyConfigCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
