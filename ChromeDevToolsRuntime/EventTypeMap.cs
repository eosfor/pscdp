    ...
    public static class EventTypeMap
    {
        ...
        static EventTypeMap()
        {
            s_methodNameEventTypeDictionary = new Dictionary<string, Type>()
            {
                ...
                { "Storage.attributionReportingSourceRegistered", typeof(Storage.AttributionReportingSourceRegisteredEvent) },
                { "Storage.attributionReportingTriggerRegistered", typeof(Storage.AttributionReportingTriggerRegisteredEvent) },
                { "Storage.attributionReportingReportSent", typeof(Storage.AttributionReportingReportSentEvent) },
            ...
            s_eventTypeMethodNameDictionary = new Dictionary<Type, string>()
            {
                ...
                { typeof(Storage.AttributionReportingSourceRegisteredEvent), "Storage.attributionReportingSourceRegistered" },
                { typeof(Storage.AttributionReportingTriggerRegisteredEvent), "Storage.attributionReportingTriggerRegistered" },
                { typeof(Storage.AttributionReportingReportSentEvent), "Storage.attributionReportingReportSent" },
