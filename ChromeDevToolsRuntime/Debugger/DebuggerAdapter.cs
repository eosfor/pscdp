namespace BaristaLabs.ChromeDevTools.Runtime.Debugger
{
    ...
    public class DebuggerAdapter
    {
        ...
        /// </summary>
        public async Task<DisassembleWasmModuleCommandResponse> DisassembleWasmModule(DisassembleWasmModuleCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// will return errors.
        /// </summary>
        public async Task<NextWasmDisassemblyChunkCommandResponse> NextWasmDisassemblyChunk(NextWasmDisassemblyChunkCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<SetBlackboxExecutionContextsCommandResponse> SetBlackboxExecutionContexts(SetBlackboxExecutionContextsCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
