namespace BaristaLabs.ChromeDevTools.Runtime.Network
{
    ...
    public class NetworkAdapter
    {
        ...
        /// </summary>
        public async Task<StreamResourceContentCommandResponse> StreamResourceContent(StreamResourceContentCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<SetCookieControlsCommandResponse> SetCookieControls(SetCookieControlsCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
