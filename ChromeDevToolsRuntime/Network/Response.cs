namespace BaristaLabs.ChromeDevTools.Runtime.Network
{
    ...
    public sealed class Response
    {
        ...
        /// Specifies that the request was served from the prefetch cache.
        ///</summary>
        [JsonProperty("fromEarlyHints", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        ///</summary>
        [JsonProperty("serviceWorkerRouterInfo", DefaultValueHandling = DefaultValueHandling.Ignore)]
        ...
        ///</summary>
        [JsonProperty("alternateProtocolUsage", DefaultValueHandling = DefaultValueHandling.Ignore)]
