namespace BaristaLabs.ChromeDevTools.Runtime.Overlay
{
    ...
    public class OverlayAdapter
    {
        ...
        /// </summary>
        public async Task<SetShowWindowControlsOverlayCommandResponse> SetShowWindowControlsOverlay(SetShowWindowControlsOverlayCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
