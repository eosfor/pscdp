namespace BaristaLabs.ChromeDevTools.Runtime.DOM
{
    ...
    public class DOMAdapter
    {
        ...
        /// </summary>
        public async Task<GetTopLayerElementsCommandResponse> GetTopLayerElements(GetTopLayerElementsCommand command = null, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<GetElementByRelationCommandResponse> GetElementByRelation(GetElementByRelationCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<GetDetachedDomNodesCommandResponse> GetDetachedDomNodes(GetDetachedDomNodesCommand command = null, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<GetAnchorElementCommandResponse> GetAnchorElement(GetAnchorElementCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
