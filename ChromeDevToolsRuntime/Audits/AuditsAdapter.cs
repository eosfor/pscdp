namespace BaristaLabs.ChromeDevTools.Runtime.Audits
{
    ...
    public class AuditsAdapter
    {
        ...
        /// using Audits.issueAdded event.
        /// </summary>
        public async Task<CheckFormsIssuesCommandResponse> CheckFormsIssues(CheckFormsIssuesCommand command = null, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
