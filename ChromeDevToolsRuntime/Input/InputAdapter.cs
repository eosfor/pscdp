namespace BaristaLabs.ChromeDevTools.Runtime.Input
{
    ...
    public class InputAdapter
    {
        ...
        /// </summary>
        public async Task<CancelDraggingCommandResponse> CancelDragging(CancelDraggingCommand command = null, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
