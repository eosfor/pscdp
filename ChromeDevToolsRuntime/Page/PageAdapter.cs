namespace BaristaLabs.ChromeDevTools.Runtime.Page
{
    ...
    public class PageAdapter
    {
        ...
        /// </summary>
        public async Task<GetAdScriptAncestryIdsCommandResponse> GetAdScriptAncestryIds(GetAdScriptAncestryIdsCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
            return await m_session.SendCommand<GetAdScriptAncestryIdsCommand, GetAdScriptAncestryIdsCommandResponse>(command, cancellationToken, millisecondsTimeout, throwExceptionIfResponseNotReceived);
        }
        /// <summary>
        ...
        /// </summary>
        public async Task<SetRPHRegistrationModeCommandResponse> SetRPHRegistrationMode(SetRPHRegistrationModeCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
        ...
        /// </summary>
        public async Task<SetPrerenderingAllowedCommandResponse> SetPrerenderingAllowed(SetPrerenderingAllowedCommand command, CancellationToken cancellationToken = default(CancellationToken), int? millisecondsTimeout = null, bool throwExceptionIfResponseNotReceived = true)
        {
